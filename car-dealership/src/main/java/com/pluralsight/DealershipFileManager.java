...
public class DealershipFileManager {
    ...
    /**
     * Method will read from file and populate the Dealership ArrayList
     * @return Dealership
     */
    public Dealership getDealership() {
        ...
        try {
            ...
            //Split the first line of the CSV by the pipeline
            ...
            //Using the above ArrayList. Populate the Dealership inventory array with all the new cars
    ...
    /**
     * This method is a utility method used to simplify the creation of a new Vehicle
     * @param carDetails
     * @return
     */
    ...
    public void saveDealership(Dealership dealership) {
        try {
            //Create a reference ArrayList that gets all the current Vehicles from the dealership
